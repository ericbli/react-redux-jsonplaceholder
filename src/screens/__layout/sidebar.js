    ...
    return (
      ...
      <nav className="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
          ...
          <ul className="nav nav-pills flex-column sidebar-nav">
              ...
              <li className="nav-item">
                <a className="nav-link"><Link to="/"><em className="fa fa-dashboard" /> Links <span className="sr-only">(current)</span></Link></a>
              </li>
              <li className="nav-item">
                <a className="nav-link"><Link to="/"><em className="fa fa-dashboard" /> Links2 <span className="sr-only">(current)</span></Link></a>
              </li>
